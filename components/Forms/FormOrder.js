...
export const FormOrder = ({ onSubmitForm }) => {
  ...
  const { setOpen, setSuccess, setMessage, Confirmation_Form_Zayavka } = useContext(ToastrContext);
  ...
  return (
    <div className='bg-black rounded-5xl'>
      ...
      <div className='px-10 pb-15 pt-9   text-center bg-white rounded-b-5xl'>
        ...
        <p className='pb-5'>Оставьте свои контактные данные и мы вышлем вам Коммерческое предложение</p>
