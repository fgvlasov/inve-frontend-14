  ...
  return (
    ...
    >
      <Wrapper color='grey' position='bottom'>
        <TitleSection text={category.attributes.name as string}> </TitleSection>
        ...
        {category.attributes.Category_why_choose && <ServicesChoice data={category.attributes.Category_why_choose as unknown} />}

        <ServicesThreePage service={category.attributes.Category_other_services as unknown} items={threeCategories} />
