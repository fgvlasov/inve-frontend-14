...
export default function ServicesChildrenItem({ title, image, pathCategory, pathDirection = "", serviceId }) {
  const linkDirection = `${
  ...
  return (
    ...
    >
      ...
      <div className='absolute bottom-9 left-9'>
        <PillowLink text='Заказать' link={linkDirection} variant='white' variantSvg='blueSvg' />
      </div>
    </div>
  );
}
