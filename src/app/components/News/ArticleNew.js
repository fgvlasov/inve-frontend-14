...
export default function ArticleNew({ link, image, tag, title, text, variant = "colorNero" }) {
  return (
    <article
    ...
    >
      <div className='rounded-l15 w-full relative'>
        ...
        {/* md:aspect-[804/287] */}
        {tag.data && (
          <Tag key={tag.data.attributes.Name} text={tag.data.attributes.Name} href={tag.data.attributes.slug} usedFor='blog' />
        )}
      </div>
