...
import ModalInputForBrief from "@/app/components/ui/ModalInputForBrief";
import ModalFieldset from "@/app/components/ui/ModalFieldset";
import ModalLabel from "@/app/components/ui/ModalLabel";
  ...
  const renderFieldInputs = (fieldInput) => {
    return (
      <ModalFieldset key={fieldInput.name}>
        <ModalLabel htmlFor={fieldInput.name} text={fieldInput.label.text} required={fieldInput.label.required} />
        {fieldInput.type === "select" ? (
          <ModalSelectForBrief name={fieldInput.name} options={fieldInput.input.options} />
